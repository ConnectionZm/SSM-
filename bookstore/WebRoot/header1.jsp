<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- navbar -->
<nav class="navbar masthead-navbar navbar-inverse" id="masthead-navbar">
    <div class="container-fluid">
        ...
        <div class="masthead-navbar-btn navbar-right dropdown">
	        ...
	        <c:if test="${!result}">
	            ...
	            <ul class="dropdown-menu animated fadeInRight m-t-xs">
	                ...
	                <li>
	                    <a href="${pageContext.request.contextPath}/selectAccountByUid.action">用户充值</a>
	                </li>
	                <li>
        ...
        <div class="navbar-collapse collapse navbar-right">
            <ul class="nav masthead-nav">
                ...
                <li><a href="about.jsp">关于BookStore</a></li>
            </ul>
        </div>
    </div>
</nav>
