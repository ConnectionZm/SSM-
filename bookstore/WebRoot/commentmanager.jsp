        ...
        <div id="page_content">
            ...
            <table class="table">
                ...
                <c:forEach items="${commentVoList}" var="commentVo">
	                	<tr>
                    <th style="vertical-align:middle;">${commentVo.username }</th>
                    <th style="vertical-align:middle;">${commentVo.email}</th>
                   	<th style="vertical-align:middle;"><img src="images/person/${commentVo.tx}" style="max-width:100px;"></th>
                    <th style="vertical-align:middle;">${commentVo.descr }</th>
                    <th style="vertical-align:middle;">
                        <a href="${pageContext.request.contextPath}/deleteCommentByManager.action?id=${commentVo.id}" onclick="return confirm('您确认删除这条评论吗?')">删除</a>
                    </th>
                </tr>
	            	</c:forEach>
