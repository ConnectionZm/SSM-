...
public class BookController {
	...
	public @ResponseBody Books selectBookById(Integer id,HttpServletRequest request) throws Exception {
	...
	public String selectBookById(Model model,Integer id,HttpServletRequest request) throws Exception {
		
		Books book = booksService.selectBookById(id);
		List<CommentVo> commentVoList=commentService.selectCommentsByBid(id);
		Users user=(Users) request.getSession().getAttribute("user");
		Account account=null;
		if(user!=null){
			account=accountService.selectAccountByUid2(user.getId());
